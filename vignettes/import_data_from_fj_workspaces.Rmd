...
**Under the hood, the .wsp file is an XML file with all population counts and statistics stored.**
...
RPTECs (renal tubular epithelial cells; scatter gate) --> DAPI-negatives --> GFP-positives
