...
Let's create a folder for our latest flow cytometry experiment. Mac-user: To copy the path of a directory use CMD+Alt+C in the Finder.
```{r}
fcexpr::new_exp(path = "/Users/vonskopnik/Documents/experiments", name = "my_experiment")
```
...
```{r}
wd <- "/Users/vonskopnik/Documents/experiments/20211005_my_experiment"
list.files(wd)
