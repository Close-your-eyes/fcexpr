...
Please install the development version of fcexpr from GitHub. This requires devtools to be installed first.
...
If you want you can start by creating a default folder for your experiment:
``` r
